...
const GoodReport = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.save(`Report Good Status.pdf`);
  };
  ...
  useEffect(() => {
    fetch("http://localhost:3001/api/get/data")
      ...
      .then((json) => {
        const GreenData = json.filter((item) => item.status === "Good");
     ...
     <body style={styles}>
      <nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900  w-full sticky z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <h1 class="text-center sm:text-left">MESIN Green CONDITION</h1>
      ...
      <main>
        <section
          ...
          x-data="app"
        >
          <div className="flex mt-1 flex-col  h-full">
            ...
            {/* <!-- Table --> */}
            <div className="w-full max-w-2xl mt-1 mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                  ...
                  <tbody className="text-sm divide-y divide-gray-100">
                    {filteredData.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td className="p-2 w-40 bg-Green-400 rounded-2xl">
                          <div className="text-center h-6 bg-[#31A207]  rounded-2xl text-black...">
                            {item.status}
                          </div>
                        </td>
