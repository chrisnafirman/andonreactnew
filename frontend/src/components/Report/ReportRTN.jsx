...
const ReuestLeader = () => {
  ...
  const exportToPDF = () => {
    ...
    const text = "Report Case Return [RTN]";
    ...
    // Menyimpan file PDF
    doc.save(`Report Case Return [RTN].pdf`);
  };
                  ...
                  <thead className="text-xs font-mono uppercase text-gray-400 bg-gray-50">
                    <tr>
                      ...
                      <th className="p-1 min-w-[180px] whitespace-no-wrap overflow-x-auto">
                        <div className="text-center flex">Return at</div>
                      </th>
                      <th className="p-1 min-w-[120px] whitespace-no-wrap overflow-x-auto">
                        <div className="text-center flex">Return From</div>
                      </th>
