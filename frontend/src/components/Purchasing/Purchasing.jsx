...
const Purchasing = () => {
  ...
  return (
    <body style={{ height: "200vh" }} class="bg-stone-400 h-screen">
      <button
      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <a href="/PURCHASING" class="flex items-center pl-2.5 mb-5">
            <img
          ...
          <ul class="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Request For PURCHASING</span>
              </a>
            </li>
            <li>
              <a
                href="/ReturnPurchasing"
                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
                  aria-hidden="true"
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Return From Quality</span>
              </a>
            </li>
          </ul>
        </div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                ...
                >
                  ...
                  <span class="ml-3 text-gray-500">Request For PURCHASING</span>
                </a>
              </li>
              <li>
                <a
