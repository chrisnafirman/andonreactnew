...
const RequestPurchasing = () => {
  ...
  useEffect(() => {
    fetch("http://192.168.101.236:3001/api/get/PURCHASING")
  ...
  const handleFilterByDate = (e) => {
    ...
    fetch(`http://192.168.101.236:3001/api/get/PURCHASING?date=${selectedDate}`)
      .then((response) => response.json())
      .then((json) => {
...
export default RequestPurchasing;
