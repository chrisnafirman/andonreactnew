...
function QRValidationValidationLeaderBE() {
  ...
  //   firebase.database().ref(`SMTLine1BE/${Station}`).set("Go");
...
export default QRValidationValidationLeaderBE;