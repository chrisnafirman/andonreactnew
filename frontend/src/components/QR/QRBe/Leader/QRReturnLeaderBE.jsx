...
function QRReturnValidationLeaderBE() {
  ...
  const submitReturnRequest = () => {
    ...
    firebase.database().ref(`SMTLine1BE/${Station}`).set(`Return ${Department}`);
...
const fetchLatestUidByStation = () => {
  fetch("http://192.168.101.12:3001/api/Repair")
    ...
    .then((data) => {
      // Filter objek yang memiliki Station sesuai dengan yang Anda inginkan, misalnya "SPI (BE)"
...
export default QRReturnValidationLeaderBE