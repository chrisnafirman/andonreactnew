...
function QROperatorBOT() {
    ...
    const submitLeader = () => {
        ...
        firebase.database().ref(`SMTLine1BOT/${Station}`).set("Leader");
    ...
    const submitMaintenance = () => {
        ...
        firebase.database().ref(`SMTLine1BOT/${Station}`).set("MAINTENANCE & IT");
        firebase.database().ref("StatusLine/SMTLine1").set("Down");
