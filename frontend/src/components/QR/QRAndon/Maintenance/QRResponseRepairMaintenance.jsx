...
function QRResponseMTCTOP() {
  ...
  const submitResponse = () => {
    ...
    notificationRepairment();
    db.ref(`${AreaFirebase}/${Station}`).set("Repair");
...
useEffect(() => {
  ...
  const notificationRepairment = () => {
    ...
    const message = `!! Attention SMT LINE 1 Under Repairment Maintenance !!%0A%0ARepair By : ${NamaPIC}%0AStation : ${Station}`;
