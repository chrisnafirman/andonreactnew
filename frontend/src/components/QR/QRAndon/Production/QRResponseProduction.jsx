...
function QRResponseValidationProductionTOP() {
  ...
  const submitResponse = () => {
    ...
    db.ref(`${AreaFirebase}/${Station}`).set("In Validation");
...
useEffect(() => {
  ...
  const notificationValidation = () => {
    ...
    const message = `!! Attention ${Line} In Validation Production !!%0A%0AValidation By : ${NamaPIC}%0AStation : ${Station}`;
...
export default QRResponseValidationProductionTOP;
