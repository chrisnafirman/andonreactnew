    ...
    return (
        <body style={styles}>
            <div className="flex flex-col  items-center  h-screen ">
                <h1 className="text-4xl mt-11  font-serif  mb-60 lg:mb-40">ProductionLeader</h1>
...
export default PortalProductionLeader;
